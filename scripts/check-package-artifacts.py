...
REQUIRED_WHEEL_ASSETS: tuple[str, ...] = (
    ...
    "ai_repo_safety/assets/templates/gitlab/.gitlab-ci.yml",
    "ai_repo_safety/assets/templates/gitlab/merge_request_templates/default.md",
    "ai_repo_safety/assets/templates/gitlab/issue_templates/security.md",
